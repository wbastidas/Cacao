...
/// Una corrección con sus pasos concretos.
class Correccion {
  const Correccion({
    required this.codigo,
    required this.problema,
    required this.porQuePasa,
    required this.pasos,
    required this.paraLaProximaVez,
  });
  ...
  final String porQuePasa;

  /// Qué hacer ahora mismo, en orden.
  final List<String> pasos;

  /// Cómo evitar que vuelva a pasar en el siguiente lote.
  final String paraLaProximaVez;
}

/// Catálogo de correcciones de la app.
class Correcciones {
  static const List<Correccion> todas = [
    Correccion(
      codigo: 'C-01',
      problema: 'Fermentación fría',
      porQuePasa:
          'La fermentación se calienta sola por la actividad de levaduras y '
      ...
      paraLaProximaVez:
          'Junta más baba antes de empezar: por debajo de la masa mínima '
          'configurada la fermentación casi siempre se enfría.',
    ),
    Correccion(
      codigo: 'C-02',
      problema: 'Muchos granos violetas',
      porQuePasa:
          'El violeta es grano que fermentó a medias. Le faltó tiempo, o los '
      ...
      paraLaProximaVez:
          'Alarga la fermentación un día y cuida que los volteos sean '
    ...
    Correccion(
      ...
      porQuePasa:
          'El grano se secó demasiado despacio o en capa muy gruesa, y quedó '
      ...
      paraLaProximaVez:
          'Empieza el secado con capa delgada los primeros dos días, que es '
          'cuando el grano suelta más agua.',
    ),
    Correccion(
      codigo: 'C-04',
      problema: 'Muchos granos pizarrosos',
      porQuePasa:
          'El pizarroso (gris y compacto) es grano que no fermentó nada. O la '
      ...
      paraLaProximaVez:
          'Junta lotes más grandes o usa un fermentador más pequeño y mejor '
          'aislado. Una caja demasiado grande para poca baba enfría la masa.',
    ),
    Correccion(
      codigo: 'C-05',
      problema: 'Olor pútrido o a amoniaco',
      porQuePasa:
          'La fermentación se pasó. Las bacterias equivocadas tomaron el '
      ...
      paraLaProximaVez:
          'Acorta la fermentación. Con CCN-51 y clima caliente, muchas veces '
          'bastan 4–5 días en vez de 6–7.',
    ),
    Correccion(
      codigo: 'C-06',
      problema: 'Chocolate arenoso',
      porQuePasa:
          'Las partículas de cacao y azúcar siguen siendo más grandes de lo '
      ...
      paraLaProximaVez:
          'Anota cuántas horas necesitó este lote y usa ese tiempo como punto '
          'de partida la próxima vez.',
    ),
    Correccion(
      codigo: 'C-07',
      problema: 'Chocolate muy ácido',
      porQuePasa:
          'Quedaron ácidos de la fermentación (sobre todo ácido acético) que '
      ...
      paraLaProximaVez:
          'Seca más despacio los primeros días: un secado muy rápido encierra '
          'los ácidos dentro del grano.',
    ),
    Correccion(
      codigo: 'C-08',
      problema: 'Fat bloom (velo grisáceo)',
      porQuePasa:
          'La manteca de cacao cristalizó mal o migró a la superficie. Pasa '
          'cuando el atemperado falla o el chocolate sufre cambios de '
          'temperatura después de moldeado.',
      pasos: [
      ...
      paraLaProximaVez:
          'Atempera y moldea a primera hora de la mañana, cuando el cuarto '
          'está más fresco.',
    ),
    Correccion(
      codigo: 'C-09',
      ...
      porQuePasa:
          'Se condensó humedad sobre el chocolate, disolvió el azúcar de la '
      ...
      paraLaProximaVez:
          'Controla la humedad del cuarto de moldeado y empaca en cuanto las '
          'barras estén frías.',
    ),
  ];

  static final Map<String, Correccion> porCodigo = {
    for (final c in todas) c.codigo: c,
  };

  static Correccion? buscar(String? codigo) =>
      codigo == null ? null : porCodigo[codigo];
}
